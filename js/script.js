      ...
      if(destination == 1) {
        ...
        if(graphSwitch == "on") {
          setTimeout(function() {
            ...
            makeChart(75, $(".javascript .per"), 'rgb(194 207 0)')
            makeChart(80, $(".sass .per"), 'rgb(182, 87, 153)')
            makeChart(75, $(".jquery .per"), 'rgb(43, 71, 145)')
            makeChart(65, $(".node .per"), 'rgb(0, 102, 46)')
            makeChart(65, $(".react .per"), 'rgb(35, 139, 139)')
            makeChart(45, $(".php .per"), 'rgb(34, 68, 105)')
            makeChart(60, $(".git .per"), 'rgb(214, 116, 86)')
            makeChart(40, $(".linux .per"), 'rgb(59, 59, 59)')
            makeChart(50, $(".photoshop .per"), 'rgb(122, 134, 246)')
            makeChart(50, $(".premiere .per"), 'rgb(225, 122, 246)')
            makeChart(85, $(".xe .per"), 'rgb(58, 58, 203)')
            makeChart(85, $(".rhymix .per"), 'rgb(212, 60, 60)')
            makeChart(40, $(".c .per"), 'rgb(3, 89, 156)')
            makeChart(40, $(".cpp .per"), 'rgb(0, 68, 130)')
            makeChart(50, $(".python .per"), 'rgb(245 196 60)')
          }, 1500)
